...
import { colorDistance, parseColor, type Lab } from "../grammar/colors"
import { formatPx } from "../grammar/lengths"
import { didYouMean } from "../grammar/similar"
import { PALETTE } from "../grammar/tailwind-theme"
...
export function nearestColorTokens(
  ...
  const prefer =
    role === "text" ? isForeground : (n: string) => !isForeground(n)
